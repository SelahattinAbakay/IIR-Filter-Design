...
module design_1
   (ap_clk_0,
    ...
    x_0,
    y_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AP_CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AP_CLK_0, ASSOCIATED_RESET ap_rst_0, CLK_DOMAIN design_1_ap_clk_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input ap_clk_0;
  ...
  design_1_IIR_Filter_0_0 IIR_Filter_0
       (.ap_clk(ap_clk_0_1),
        .ap_rst(ap_rst_0_1),
        .x(x_0_1),
        .y(IIR_Filter_0_y));
